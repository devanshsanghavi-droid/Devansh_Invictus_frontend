  ...
  return (
    <section className="w-full border-b border-slate-200">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        <div className="pt-36 pb-16 lg:pt-44 lg:pb-20">
          <p className="eyebrow mb-5">Data &amp; AI engineering</p>
          <h1 className="text-[2.5rem] leading-[1.08] md:text-6xl lg:text-[4.25rem] font-semibold text-slate-900 mb-6 max-w-5xl">

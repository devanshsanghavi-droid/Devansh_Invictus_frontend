...
interface LightSubpageLayoutProps {
  title: string;
  subtitle: string;
  icon: string;
  backLink: string;
...
export const LightSubpageLayout: React.FC<LightSubpageLayoutProps> = ({
  title,
  subtitle,
  icon,
  backLink,
    ...
    <LightLayout>
      <div className="w-full max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="bg-white/70 backdrop-blur-md rounded-2xl border border-gray-200/50 shadow-lg p-8 mb-12">
            ...
            <div className="flex flex-wrap gap-3">
              {tools.map((tool, index) => (
                <span key={index} className="px-4 py-2 bg-[#2563EB]/10 text-[#2563EB] rounded-full text-sm font-medium border border-[#2563EB]/20">
                  {tool}
                </span>
              ))}
            </div>
        ...
        <div className="text-center bg-gradient-to-r from-[#2563EB]/5 to-[#0EA5E9]/5 backdrop-blur-md rounded-2xl border border-[#2563EB]/10 shadow-lg p-12">
          ...
          <CustomButton size="lg" className="bg-gradient-to-r from-[#2563EB] to-[#0EA5E9] hover:from-[#2563EB]/80 hover:to-[#0EA5E9]/80 text-white">
            {ctaText}
          </CustomButton>
        </div>
      </div>
...
export default LightSubpageLayout;

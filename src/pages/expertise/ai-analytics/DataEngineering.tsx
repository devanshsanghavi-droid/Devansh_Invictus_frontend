...
import { ArrowLeft, CheckCircle, Database, Sparkles } from "lucide-react";
...
const DataEngineering: React.FC = () => {
  ...
  const tools = [
    "Snowflake", "dbt", "Apache Airflow", "AWS Glue", "Python", "SQL", 
    "Apache Spark", "Kafka", "Docker", "Kubernetes"
  ];

  const useCases = [
    "Building 360° customer data views",
    "Real-time KPI pipeline implementation", 
      ...
      <div className="w-full min-h-screen bg-white overflow-hidden relative">
        ...
        <div className="relative z-10">
          <div className="w-full max-w-6xl mx-auto px-6 py-12 pt-40">
            {/* Back Navigation */}
            {/* Remove the Link and span containing 'Back to AI & Analytics Intelligence' */}
            ...
            <div className="flex flex-col items-center text-center mb-16">
              <div className="flex items-center justify-center gap-4 mb-6 animate-fade-in">
                <div className="w-20 h-20 bg-gradient-to-br from-[#1E3A8A] via-[#2563EB] to-[#93C5FD] rounded-3xl flex items-center justify-center shadow-2xl animate-pulse-slow">
                  <Database className="w-10 h-10 text-slate-900 animate-bounce" />
                </div>
              ...
              <div className="flex items-center justify-center gap-2 mb-4 animate-fade-in">
                ...
                <span className="text-2xl font-semibold text-[#1E40AF] font-['Lexend'] tracking-wide uppercase">Modern Data Stacks That Scale</span>
                <Sparkles className="w-6 h-6 text-[#1E40AF] animate-spin-slow" />
              </div>
              <p className="text-xl md:text-2xl font-['DM_Sans'] text-slate-600 max-w-2xl mx-auto leading-relaxed animate-fade-in">
                Build robust, scalable, and future-ready data infrastructure for your business.
              </p>
            </div>
            ...
            <div className="mb-20 space-y-12">
              <div className="bg-white backdrop-blur-2xl rounded-3xl border border-[#2563EB]/30 shadow-2xl p-10 transition-transform duration-300 hover:scale-[1.02] hover:shadow-[#2563EB]/30 animate-fade-in">
                <h2 className="text-3xl font-extrabold font-['Lexend'] text-slate-900 mb-6 tracking-tight">Modern Data Stacks That Scale</h2>
                <div className="space-y-5 text-slate-700 font-['DM_Sans'] text-lg leading-relaxed">
                  <p>
                    Transform your raw data into a strategic asset with our comprehensive data engineering solutions. 
                    We build robust, scalable data pipelines that ensure your organization has access to clean, 
                    reliable, and timely data for critical business decisions.
                  </p>
                  <p>
                    Our data engineering approach focuses on creating flexible architectures that can adapt to 
                    your evolving business needs while maintaining high performance and data quality standards.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Data Pipeline Development</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Design and implement robust ETL/ELT pipelines that handle large volumes of data 
                    from multiple sources with built-in error handling and monitoring.
                  </p>
                </div>
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Data Warehouse Design</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Create optimized data warehouse schemas that support both analytical workloads 
                    and operational reporting with best-in-class performance.
                  </p>
                </div>
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Real-time Processing</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Implement stream processing solutions for real-time analytics and immediate 
                    response to critical business events and opportunities.
                  </p>
                </div>
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Data Governance</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Establish comprehensive data governance frameworks ensuring data quality, 
                    lineage tracking, and compliance with regulatory requirements.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center bg-gradient-to-br from-[#1E3A8A]/80 via-[#2563EB]/60 to-[#93C5FD]/60 backdrop-blur-2xl rounded-3xl border border-[#2563EB]/40 shadow-2xl p-16 animate-fade-in">
              ...
              <CustomButton size="lg" className="bg-gradient-to-r from-[#1E3A8A] via-[#2563EB] to-[#93C5FD] hover:from-[#1E3A8A]/80 hover:via-[#2563EB]/80 hover:to-[#93C5FD]/80 text-slate-900 shadow-xl animate-pulse-slow text-2xl px-10 py-5 rounded-full">
                Explore Data Engineering Use Cases
              </CustomButton>
            </div>
          </div>
        </div>

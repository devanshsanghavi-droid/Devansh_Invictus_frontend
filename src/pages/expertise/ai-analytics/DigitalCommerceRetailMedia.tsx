...
const DigitalCommerceRetailMedia: React.FC = () => {
  const [showContactForm, setShowContactForm] = useState(false);
  const tools = [
    "CommerceIQ", "DataHawk", "Amazon Ads", "Google Analytics", "Shopify Analytics",
    "Klaviyo", "Segment", "BigQuery", "Tableau", "Python", "SQL", "Power BI"
  ];
          ...
          <div className="w-full max-w-6xl mx-auto px-6 py-12 pt-40">
            ...
            <div className="flex flex-col items-center text-center mb-16">
              <div className="flex items-center justify-center gap-4 mb-6 animate-fade-in">
                <div className="w-20 h-20 bg-gradient-to-br from-[#1E3A8A] via-[#2563EB] to-[#93C5FD] rounded-3xl flex items-center justify-center shadow-2xl animate-pulse-slow">
                  <ShoppingCart className="w-10 h-10 text-slate-900 animate-bounce" />
                </div>
                <h1 className="text-5xl lg:text-6xl font-extrabold font-['Lexend'] text-slate-900 drop-shadow-lg">
                  Digital Commerce & Retail Media
                </h1>
              </div>
              <div className="flex items-center justify-center gap-2 mb-4 animate-fade-in">
                <Sparkles className="w-6 h-6 text-[#1E40AF] animate-spin-slow" />
                <span className="text-2xl font-semibold text-[#1E40AF] font-['Lexend'] tracking-wide uppercase">Winning the Digital Shelf with Data</span>
                <Sparkles className="w-6 h-6 text-[#1E40AF] animate-spin-slow" />
              </div>
              <p className="text-xl md:text-2xl font-['DM_Sans'] text-slate-600 max-w-2xl mx-auto leading-relaxed animate-fade-in">
                Optimize your digital commerce strategy with comprehensive analytics and retail media insights.
              </p>
            </div>
            ...
            <div className="mb-20 space-y-12">
              <div className="bg-white backdrop-blur-2xl rounded-3xl border border-[#2563EB]/30 shadow-2xl p-10 transition-transform duration-300 hover:scale-[1.02] hover:shadow-[#2563EB]/30 animate-fade-in">
                <h2 className="text-3xl font-extrabold font-['Lexend'] text-slate-900 mb-6 tracking-tight">E-commerce Excellence Through Data</h2>
                <div className="space-y-5 text-slate-700 font-['DM_Sans'] text-lg leading-relaxed">
                  <p>
                    Optimize your digital commerce strategy with comprehensive analytics and retail media insights.
                    Our e-commerce solutions help you win on the digital shelf and maximize revenue across all channels.
                  </p>
                  <p>
                    From product optimization to retail media measurement, we provide end-to-end analytics that drive
                    sustainable growth in competitive digital marketplaces.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Digital Shelf Analytics</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Comprehensive analysis of product performance across digital channels
                    to optimize listings, pricing, and inventory management.
                  </p>
                </div>
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Retail Media Intelligence</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Advanced analytics for retail media campaigns that measure true incremental
                    impact and optimize advertising spend across platforms.
                  </p>
                </div>
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Competitive Analysis</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Market intelligence and competitive benchmarking to identify opportunities
                    and maintain competitive advantage in digital marketplaces.
                  </p>
                </div>
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Customer Analytics</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Deep customer insights and journey analytics that inform product development,
                    marketing strategies, and customer experience optimization.
                  </p>
                </div>
              </div>
            </div>
...
export default DigitalCommerceRetailMedia;

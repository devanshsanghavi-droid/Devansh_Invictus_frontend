...
import { ArrowLeft, CheckCircle, BarChart3, Sparkles } from "lucide-react";
...
const DataVisualization: React.FC = () => {
  ...
  const tools = [
    "Power BI", "Tableau", "Looker", "D3.js", "Plotly", "Superset",
    "React", "Python", "R", "Streamlit", "Dash", "Observable"
  ];
          ...
          <div className="w-full max-w-6xl mx-auto px-6 py-12 pt-40">
            ...
            <div className="flex flex-col items-center text-center mb-16">
              <div className="flex items-center justify-center gap-4 mb-6 animate-fade-in">
                <div className="w-20 h-20 bg-gradient-to-br from-[#1E3A8A] via-[#2563EB] to-[#93C5FD] rounded-3xl flex items-center justify-center shadow-2xl animate-pulse-slow">
                  <BarChart3 className="w-10 h-10 text-slate-900 animate-bounce" />
                </div>
              ...
              <div className="flex items-center justify-center gap-2 mb-4 animate-fade-in">
                ...
                <span className="text-2xl font-semibold text-[#1E40AF] font-['Lexend'] tracking-wide uppercase">Storytelling with Data</span>
                <Sparkles className="w-6 h-6 text-[#1E40AF] animate-spin-slow" />
              </div>
              <p className="text-xl md:text-2xl font-['DM_Sans'] text-slate-600 max-w-2xl mx-auto leading-relaxed animate-fade-in">
                Create compelling visual narratives that make complex data accessible and actionable for stakeholders.
              </p>
            </div>
            ...
            <div className="mb-20 space-y-12">
              <div className="bg-white backdrop-blur-2xl rounded-3xl border border-[#2563EB]/30 shadow-2xl p-10 transition-transform duration-300 hover:scale-[1.02] hover:shadow-[#2563EB]/30 animate-fade-in">
                <h2 className="text-3xl font-extrabold font-['Lexend'] text-slate-900 mb-6 tracking-tight">Transform Data into Insights</h2>
                <div className="space-y-5 text-slate-700 font-['DM_Sans'] text-lg leading-relaxed">
                  <p>
                    Create compelling visual narratives that make complex data accessible and actionable for stakeholders.
                    Our visualization experts design intuitive dashboards that drive informed decision-making.
                  </p>
                  <p>
                    From executive summaries to detailed operational dashboards, we craft data stories that resonate
                    with your audience and support strategic business objectives.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Executive Dashboards</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    High-level strategic dashboards that provide executives with key performance indicators
                    and business metrics at a glance.
                  </p>
                </div>
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Interactive Analytics</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Self-service analytics platforms that empower users to explore data
                    and generate insights through intuitive drag-and-drop interfaces.
                  </p>
                </div>
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Real-time Monitoring</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Live dashboards that display real-time metrics and alerts to help teams
                    respond quickly to changing business conditions.
                  </p>
                </div>
                <div className="bg-white backdrop-blur-2xl rounded-2xl border border-[#2563EB]/30 shadow-xl p-8 transition-transform duration-300 hover:scale-105 hover:shadow-[#2563EB]/30 animate-fade-in">
                  <h3 className="text-2xl font-bold font-['Lexend'] text-[#1E40AF] mb-4">Custom Visualizations</h3>
                  <p className="text-slate-700 font-['DM_Sans'] text-base leading-relaxed">
                    Bespoke data visualizations designed to communicate complex information
                    clearly and effectively for your specific use case.
                  </p>
                </div>
              </div>
            </div>

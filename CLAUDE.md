...
- **The client marquee lists only 3 real clients** (Votorantim Group, PwC Brazil, Tegma
  Logística) — the only ones the site already named publicly. Do not pad that array with
  invented company names; ask for the cleared list instead.
